...
public class ExemploIf
{
	public static void Main()
	{
		...
		if (VarNumero < 10) {Console.WriteLine(" O Numero possui 1 digito ");} 
		
		else if (VarNumero < 100) {Console.WriteLine(" O Numero possui 2 dígitos ");}
		...
		if (VarNumero > 2)
		{			
			if (VarNumero < 8) {Final = VarNumero;}
